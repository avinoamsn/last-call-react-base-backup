...
export class RegisterSubscriber extends Component {
  ...
  constructor(props) {
    ...
    fetch('api/Subscribers/RegisterSubscriber')
  ...
  static renderOffersTable(meals) {
    ...
    render() {
        let contents = this.state.loading ? <p><em>Loading...</em></p> : RegisterSubscriber.renderOffersTable(this.state.meals);
